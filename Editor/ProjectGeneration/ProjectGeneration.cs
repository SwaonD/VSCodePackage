...
namespace VSCodeEditor
{
    ...
    ""files.exclude"":
    {
        ...
        static string k_TargetFrameworkVersion = FrameworkVersion.GetFrameWorkVersion(); //"v4.7.1";
        static string k_TargetFramework = k_TargetFrameworkVersion.Replace("v", "").Replace(".", ""); //"471";
      ...
      return otherArguments["analyzer"].Concat(otherArguments["a"])
        ...
        )
        {
            ...
            builder.Append(@"    <TargetFramework>").Append(k_TargetFramework).Append("</TargetFramework>").Append(k_WindowsNewline);
            ...
            // builder.Append(@"     <Compile Include=""Assets\Scripts\**\*.cs"" />").Append(k_WindowsNewline); pb car include plusieurs fois le meme prgm
        }
